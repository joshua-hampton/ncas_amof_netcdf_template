...
def test_product_dict_with_local_files():
    ...
    result = tsv2dict.product_dict(
        "product1", platform="loc1", deployment_loc="land", use_local_files="/local/path", tag="tag1"
    )
    ...
    result = tsv2dict.product_dict(
        "product1", instrument_loc="loc1", deployment_loc="land", use_local_files="/local/path", tag="tag1"
    )
...
def test_product_dict():
    ...
    result = tsv2dict.product_dict(
        "product1", platform="loc1", deployment_loc="land", use_local_files="/local/path"
    )
